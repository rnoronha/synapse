...
class RouterProcess:
    ...
    def __init__(self, listen_fd, worker_uds_fds):
        ...
        # Set all worker UDS fds non-blocking so a slow worker
    ...
    def router_main(self):
        ...
        os.setsid()
        # Ensure router dies if parent exits unexpectedly
        try:
            import ctypes
    ...
    def _do_accept(self, listen_sock):
        ...
        # Try round-robin workers; skip any whose UDS would block.
        ...
        for _ in range(len(pool)):
            ...
            try:
                ...
                # detach() releases Python wrapper without closing fd — intentional for fd passing
                uds_sock.detach()
            if dispatched:
                break
