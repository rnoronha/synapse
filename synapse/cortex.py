...
class Cortex(s_oauth.OAuthMixin, s_cell.Cell):  # type: ignore
    ...
    async def prepareFork(self):
        ...
        # Create a separate listen socket for the router
        thick_port = 27493
        ...
        self._forkinfo['router_listen_fd'] = thick_sock.fileno()
        # Prevent GC from closing the socket
        self._thick_listen_sock = thick_sock
        logger.info('Fork mode: router listen socket on port %d', thick_port)
